...
/**
 * print_python_bytes - show the size, string representation, and hex
...
/**
 * print_python_float - prints Python value float object: at least one
 ...
 * @p: PyObject *-castable struct pointer
 */
void print_python_float(PyObject *p) /* prototype */
{
	char float_str[40];
...
/**
 * print_python_list - shows member count, allocated spaces, and member
